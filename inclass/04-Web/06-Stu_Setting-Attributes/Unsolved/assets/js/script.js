...
var divFour = document.querySelectorAll("h4")

console.log (divFour)

for (var i =0; i < divFour.length; i++){
  divFour[i].setAttribute("style", "color: red; font-size: 30px; font-weight: bold; padding-left: 30px;")
}